    ...
    <div className="min-h-screen bg-gray-50 flex text-gray-900">
      <aside className="w-64 shrink-0 bg-white border-r border-gray-200 flex flex-col">
        <div className="px-5 py-5 flex items-center gap-3 border-b border-gray-100">
          ...
          <div>
            <p className="font-bold leading-tight">CircuitSJ</p>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          <p className="px-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider mt-5 mb-1">
            More (coming soon)
          </p>
          {['Advertisement', 'Site Settings'].map((label) => (
            <div
              key={label}
            ...
            >
              <span>{label}</span>
              <span className="text-[10px] bg-gray-100 text-gray-400 px-1.5 py-0.5 rounded">soon</span>
            </div>
          ))}
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2.5 px-3 py-2 mt-5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition"
          >
            <span>🌐</span>
            View Site
          </a>
